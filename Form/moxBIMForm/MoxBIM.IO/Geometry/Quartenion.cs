// Funcion Based in XbimQuaternion //
// https://github.com/xBimTeam/XbimEssentials/blob/master/Xbim.Common/Geometry/XbimQuaternion.cs
// End;
...
namespace MoxGraphics.Geometry
{
    ...
    public struct MoxQuaternion
    {
        #region members

        private static readonly MoxQuaternion _identity;
        private double _x;
        private double _y;
        private double _z;
        private double _w;
        ...
        static MoxQuaternion()
        {
            _identity = new MoxQuaternion(0.0, 0.0, 0.0, 1.0);
            _identity._isNotDefaultInitialised = true;
        }


        public MoxQuaternion(double x, double y, double z, double w)
        {
            this._x = x;
            this._y = y;
            this._z = z;
        ...
        public static void RotationMatrix(ref MoxMatrix3D matrix, out MoxQuaternion result)
        {
            double sqrt;
            double half;
            double scale = matrix.M11 + matrix.M22 + matrix.M33;
            result = new MoxQuaternion();
        ...
        public static void Transform(ref MoxVector3D vector, ref MoxQuaternion rotation, out MoxVector3D result)
        {
